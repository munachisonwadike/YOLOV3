...
def box_scale(img1_shape, coords, img0_shape):
...
# Plotting functions ---------------------------------------------------------------------------------------------------
def single_box_plot(x, img, color=None, obj_label=None, line_thickness=None):
    ...
    if obj_label:
        ...
        t_size = cv2.getTextSize(obj_label, 0, fontScale=tl / 3, thickness=tf)[0]
        c2 = c1[0] + t_size[0], c1[1] - t_size[1] - 3
        cv2.rectangle(img, c1, c2, color, -1)  # filled
        cv2.putText(img, obj_label, (c1[0], c1[1] - 2), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
